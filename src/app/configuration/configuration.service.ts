...
export class ConfigurationService {
  ...
  pullAdhocConfigDetails(obj): Observable<any> {
    return this.http.post(
      environment.configBaseUrl + environment.configApiEndPoint.adhocRequest,
      obj,
      { headers: headers }
    );
  }
  ...
  getAllloginUser(): Observable<any> {
    return this.http.get(
      environment.configBaseUrl +
        environment.configApiEndPoint.getAllDevloginUser,
      { headers: headers }
    );
  }
